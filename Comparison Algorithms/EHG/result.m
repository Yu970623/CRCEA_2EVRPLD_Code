%% ----------------------´æ´¢¼ÆËãµÄ½á¹û-----------------------------
function result(vrp2e,name,opt_vrps,opt_vlts,opt_cuss,opt_sats,opt_caps,vrps_covs,vltc_covs,cpu_time)
...
%     movefile('time*',file_path);
    save(['vrp_data/',name,'.mat'],'vrp2e','opt_vrps','opt_vlts','opt_cuss','opt_sats','opt_caps','vrps_covs','vltc_covs','cpu_time');
end